/**
* Implémentation classe WhitePawnPromotionDialog
* \file   WhitePawnPromotionDialog.cpp
...
WhitePawnPromotionDialog::WhitePawnPromotionDialog(std::pair<int, int> position, QWidget *parent)
	: QDialog(parent)
{
	setWindowFlags(windowFlags() & ~Qt::WindowCloseButtonHint);
	setWindowFlags(windowFlags() & ~Qt::WindowContextHelpButtonHint);
	setWindowTitle("White Pawn Promotion");
	...
	button1->setIcon(QIcon(QString::fromStdString("Images/WhiteQueen.png")));
	button1->setIconSize(QSize(90, 90));
	button1->setProperty("piece", QVariant::fromValue<char>('Q'));
	button1->setProperty("color", QVariant::fromValue<char>('W'));
	...
	button2->setIcon(QIcon(QString::fromStdString("Images/WhiteKnight.png")));
	button2->setIconSize(QSize(90, 90));
	button2->setProperty("piece", QVariant::fromValue<char>('K'));
	button2->setProperty("color", QVariant::fromValue<char>('W'));
	...
	button3->setIcon(QIcon(QString::fromStdString("Images/WhiteRook.png")));
	button3->setIconSize(QSize(90, 90));
	button3->setProperty("piece", QVariant::fromValue<char>('R'));
	button3->setProperty("color", QVariant::fromValue<char>('W'));
	...
	button4->setIcon(QIcon(QString::fromStdString("Images/WhiteBishop.png")));
	button4->setIconSize(QSize(90, 90));
	button4->setProperty("piece", QVariant::fromValue<char>('B'));
	button4->setProperty("color", QVariant::fromValue<char>('W'));
...
void WhitePawnPromotionDialog::keyPressEvent(QKeyEvent* e)
{
